...
class WireFixtureGenerator {
	...
	private fun transport(root: JsonObject): List<Fixture> {
		...
		return listOf(
			...
			transportCase("apiReachable", "ConsoleRouterTransport.buildHealthRequest", client.transport.buildHealthRequest("https://router.test"), expect = "{\"ok\":true,\"protocolVersion\":${com.atelier_nyaarium.switchboard.proto.Protocol.FEDERATION_PROTOCOL_VERSION}}"),
