...
4. ✅ `bd_eb11a34b18d4335a7e0248d43268b354` `FacetRules` split into seven owners (`FacetText`, `FacetStateRules`, `FacetFactsRules`, `FacetUseRules`, `FacetStructureRules`, `FacetHistoryRules`, `FacetDetailRules`), every rule moved unchanged. Shipped `21a9818f`.
